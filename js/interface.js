var minersAddr = '0x4D7302C99b2bc3eA8E5fD7E1Fb07aFe63CaDDC2D';
var tokenAddr = '0xa40132FB78b4C3DfB77d953fBC212E84d3C865Ae';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " MEXA -$MXA- in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " MEXA -$MXA- first");
	} else {
